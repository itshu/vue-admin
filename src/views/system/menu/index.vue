<template>
  <div class="app-container">
    ...
    <tree-table v-loading="loading" :data="data" :expand-all="true" :columns="columns" border size="small">
      ...
      <el-table-column prop="num" align="center" width="100px" label="排序">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.num }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column :show-overflow-tooltip="true" prop="url" label="链接地址"/>
      <el-table-column :show-overflow-tooltip="true" prop="code" label="组件路径"/>
      ...
      <!--<el-table-column prop="createTime" label="创建日期" hidden>-->
        <!--<template slot-scope="scope">-->
